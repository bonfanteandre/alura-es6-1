...
System.register(['../models/Negociacao', '../models/ListaNegociacoes', '../models/Mensagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../helpers/DateHelper', '../helpers/Bind'], function (_export, _context) {
    ...
    var Negociacao, ListaNegociacoes, Mensagem, NegociacoesView, MensagemView, NegociacaoService, DateHelper, Bind, _createClass, NegociacaoController, negociacaoController;
                ...
                _createClass(NegociacaoController, [{
                    ...
                    value: function importaNegociacoes() {
                        ...
                        this._service.importa(this._listaNegociacoes.negociacoes).then(function (negociacoes) {
                            ...
                            _this4._mensagem.texto = 'Negociacções importadas com sucesso!';
                        }).catch(function (erro) {
